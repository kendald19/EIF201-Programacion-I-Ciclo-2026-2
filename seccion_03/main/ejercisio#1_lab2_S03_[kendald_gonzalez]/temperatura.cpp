...
void ingresarTemperaturas(double* registro, int cantidad) {
	std::cout << std::endl << "Ingrese las tenperaturas en grados Celsius:" << std::endl;
...
void mostrarResultados(const double* registro, int cantidad) {
	...
	std::cout << " Temperatura mахіmа: "<< calcularMaximo(registro, cantidad)<< "C" << std::endl;
